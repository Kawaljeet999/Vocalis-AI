...
> <span style="color: white; font-weight: bold;">⚠️ Note: The live link may take a few seconds to start due to server spin-up time on free hosting.<br>
> Please be patient. For the best experience, consider running the app locally, which offers faster performance.</span>
